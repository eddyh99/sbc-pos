                            ...
                            <div class="col-lg-6">
                                <div class="card-body">
                                    <div class="form-group row my-3">
                                        ...
                                        <div class="col-sm-7">
                                        <input type="hidden" name="oldkategori" value="<?=$detail['namakategori']?>">
                                        <input type="text" class="form-control" id="kategori" name="kategori" value="<?= $detail['namakategori']?>" maxlength="50">
                                        </div>
                                    </div>
                                </div>
                            </div>
