			...
			<div class="row">
                ...
                <div class="card mt-10">
                    ...
                    <div class="card-content">
                        <form id="form_input" method="post" action="<?=base_url()?>admin/brand/updateData">
                            <div class="col-lg-6">
                                <div class="card-body">
                                <div class="form-group row my-3">
                                    <label class="col-sm-3 col-form-label">Nama Brand</label>
                                    <div class="col-sm-7">
                                    <input type="hidden" name="oldbrand" value="<?=$detail['oldbrand']?>">
                                    <input type="text" class="form-control" id="brand" name="brand" value="<?= $detail['brand']?>" maxlength="50">
                                    </div>
                                </div>
                                <div class="form-group row my-3">
